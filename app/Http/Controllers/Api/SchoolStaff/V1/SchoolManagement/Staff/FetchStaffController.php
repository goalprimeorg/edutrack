...
use App\Http\Requests\Api\SchoolStaff\V1\SchoolManagement\Staff\FetchStaffRequest;
use App\Http\Resources\Api\SchoolStaff\V1\SchoolManagement\Staff\FetchStaffResource;
...
class FetchStaffController extends Controller
{
    ...
    public function __invoke(FetchStaffRequest $request)
    {
        ...
        $listSchoolStaffsRecordOptions = $request->safe()->merge([
