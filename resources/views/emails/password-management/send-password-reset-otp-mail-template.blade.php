                ...
                <tr>
                  <td style='font-family: sans-serif; font-size: 14px; vertical-align: top;'>
                    ...
                    <p
                      ...
                      A request to change your account password was initiated. Please use the otp below to access your reset your password(Remember the otp token expires at {{ $expiresAt }}):<br><br>
                    ...
                    <p
                      ...
                      Warm Regards,<br>
                      <strong> The Edutrack Team. </strong>
                      <br>
                    </p>
                  </td>
                </tr>
            ...
            <td style='padding: 20px 35px;'>
              ...
              <p style="font-family: 'Exo', sans-serif; font-size: 11px; text-align: left; color: #666;">You have
                ...
                service-related emails. If you want to cancel your account, please contact <a
                  ...
                  style='color: inherit; text-decoration: underline;'>{{ env('ACCOUNTS_CANCELLATION_EMAIL') }}</a>.</p>

              <p
                style="font-family: 'Exo', sans-serif; font-size: 11px; font-weight: 400; text-align: left; color: #666;">
                Edutrack will never email you and ask you to disclose or verify your password, credit
