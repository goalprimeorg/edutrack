...
use App\Http\Requests\Api\SchoolStaff\V1\PasswordManagement\ResetPassword\RequestPasswordResetRequest;
...
class RequestPasswordRequestOtpTokenController extends Controller
{
    ...
    public function __invoke(RequestPasswordResetRequest $request)
    {
        ...
        return generateSuccessApiMessage('Staff requested password reset successfully');
    }
}
